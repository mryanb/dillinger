...
var Gitlab = (function() {
  ...
  function _listRepos(repos) {
    ...
    var list = '<li class="gitlab_org"><a href="#">Back to organizations...</a></li>'
  ...
  function _listBranches(repo, branches) {
    ...
    var list = '<li class="gitlab_repo"><a href="#">Back to repositories...</a></li>'
